...
ssh root@47.113.123.190 "mkdir -p /opt/ProBigA/tools /opt/ProBigA/server/api/routers /opt/ProBigA/server/static /opt/ProBigA/server/static/js /opt/ProBigA/server/static/css"
...
scp server\api\routers\portfolio_math.py root@47.113.123.190:/opt/ProBigA/server/api/routers/portfolio_math.py
if errorlevel 1 goto fail
