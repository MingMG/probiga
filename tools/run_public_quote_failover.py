#!/usr/bin/env python3
"""Run one audited public-quote fallback collection tick."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--force",
        action="store_true",
        help="Collect even when the QMT primary is healthy.",
    )
    parser.add_argument(
