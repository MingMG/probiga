...
DATASETS = {
    ...
    "capital_flow_daily": DatasetSpec("capital_flow_daily", "guojin_qmt", "sm_stock_capital_flow_daily", "primary", "stock_code", ("stock_code", "trade_date"), "transactioncount1d", ("none",), "stock", time(15, 40), persisted_source="gj_big_qmt_inner"),
