...
DATASETS = {
    ...
    "capital_flow_daily": DatasetSpec("capital_flow_daily", "eastmoney", "sm_stock_capital_flow_daily", "primary", "stock_code", ("stock_code", "trade_date"), "1d", ("none",), "stock", time(15, 40), persisted_source="push2hist"),
    ...
    "alist_daily": DatasetSpec("alist_daily", "eastmoney", "st_a_list_daily", "primary", "stock_code", ("stock_code", "trade_date", "trade_id"), "1d", ("none",), "stock", time(18), True, "eastmoney"),
    "alist_detail": DatasetSpec("alist_detail", "eastmoney", "st_a_list_info", "primary", "stock_code", ("stock_code", "trade_date", "operate_code", "trade_id", "report_side"), "1d", ("none",), "stock", time(18), True, "eastmoney"),
    "notices": DatasetSpec("notices", "eastmoney", "si_notice_eastmoney", "primary", "stock_code", ("stock_code", "art_code"), "1d", ("none",), "stock", time(18), True, "eastmoney"),
