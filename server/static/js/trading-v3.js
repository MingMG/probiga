(function(){
  ...
  function shouldDisplayResearchPool(formalCurrent,pool,requestedDate,formalRequestedDate){var researchDate=String(requestedDate||'').slice(0,10),formalDate=String(formalRequestedDate||'').slice(0,10);return researchPoolIsReadable(pool,researchDate)&&(formalCurrent!==true||researchDate!==formalDate)}
